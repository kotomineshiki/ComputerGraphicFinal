...
{
	if (m_pScene == NULL || m_pScene->mAnimations == NULL) {
		return;
	}
	...
	float TicksPerSecond = (float)(m_pScene->mAnimations[0]->mTicksPerSecond != 0 ? m_pScene->mAnimations[0]->mTicksPerSecond : 50.0f);
