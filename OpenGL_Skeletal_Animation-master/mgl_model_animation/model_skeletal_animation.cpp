...
int model_skeletal_animation()
{
	...
	//running.LoadMesh("resources/Models/running/model.dae");//�����ܲ�����
	//harpyCat.LoadMesh("resources/Models/Humpback whale/5.fbx");//���˶���
	//chicken.LoadMesh("resources/Models/test/chicken/1.fbx");//С������

	//glm::mat4 model(1.0f);

	//Shader SkinnedShader("skinning.vs", "skinning2");
	
	//ourModel.LoadMesh("resources/Models/test/MeshSmith/Fantasy1/Lady Fairy/Mesh/Lady Fairy.fbx");//��̬С����
	//ourModel.LoadMesh("resources/Models/bob_lamp_update/boblampclean.md5mesh");����,�����ǵ�����,����Դ���Բ���
